...
export const NEWS_ARTICLES: NewsArticle[] = [
  {
    id: 'n1',
    title: 'Peluncuran Sistem Digital Terpadu dan Sosialisasi Kurikulum Salaf-Modern',
    summary: 'PP Darul Mushtofa Assunniyyah meluncurkan sistem manajemen santri digital untuk mempermudah pemantauan setoran hafalan dan perkembangan akademik santri.',
    content: `Yosowilangun, Lumajang – Dalam upaya meningkatkan pelayanan pendidikan santri di era digital tanpa mengikis tradisi luhur pesantren salaf, Pondok Pesantren Darul Mushtofa Assunniyyah secara resmi meluncurkan Sistem Informasi Akademik Pesantren Terpadu.

Peluncuran sistem ini dihadiri oleh seluruh dewan asatidz dan pengurus yayasan di Aula Utama Pesantren. Pimpinan Umum KH Ali Sibro Mulisi dalam amanatnya menegaskan bahwa teknologi merupakan sarana berkhidmat untuk menyebarkan ilmu agama dan meningkatkan transparansi komunikasi dengan para wali santri.

"Pesantren salaf tidak boleh tertinggal dalam memanajemen tata kelola modern. Melalui integrasi teknologi ini, orang tua dapat memantau capaian hafalan Al-Qur'an, muthala'ah kitab kuning, serta kesehatan buah hati mereka dengan tenang dari rumah," terang KH Ali Sibro Mulisi.

Selain peluncuran sistem digital, kegiatan ini dilanjutkan dengan seminar sosialisasi kurikulum integratif yang memadukan kurikulum Kemenag (MTs dan MA) dengan kurikulum Salafiyah Madrasah Diniyah Takmiliyah.`,
    category: 'Berita',
    image: 'https://images.unsplash.com/photo-1543269865-cbf427effbad?auto=format&fit=crop&w=800&q=80',
    date: '10 Mei 2026',
    author: 'Humas PP Darul Mushtofa',
    readTime: '4 menit'
  },
  {
    id: 'n2',
    title: 'Santri Darul Mushtofa Raih Juara Umum MQK Tingkat Kabupaten Lumajang',
    summary: 'Prestasi gemilang diraih oleh kafilah PP Darul Mushtofa Assunniyyah yang sukses memborong puluhan medali emas dan perak pada ajang MQK 2026.',
    content: `Lumajang – Kebahagiaan luar biasa menyelimuti segenap keluarga besar Pondok Pesantren Darul Mushtofa Assunniyyah Yosowilangun, Lumajang. Kafilah santri utusan pondok berhasil menyabet predikat Juara Umum dalam ajang bergengsi Musabaqah Qira'atil Kutub (MQK) tingkat Kabupaten Lumajang yang diselenggarakan oleh Kantor Kementerian Agama Kabupaten Lumajang.

Lomba membaca dan menerangkan kitab kuning ini diikuti oleh lebih dari 50 pondok pesantren se-Kabupaten Lumajang. PP Darul Mushtofa Assunniyyah berhasil meraih total 12 medali emas, 8 perak, dan 5 perunggu pada berbagai cabang perlombaan, mulai dari tingkat Fathul Qarib (Fiqih), Safinatun Najah (Tauhid), Imrithi (Nahwu), hingga tingkat tertinggi Fathul Mu'in dan Alfiyah Ibnu Malik.

Pengasuh Utama, KH Ali Sibro Mulisi, menyampaikan rasa syukur dan bangganya atas kesungguhan para santri dalam bermuthala'ah (mempelajari) materi kitab-kitab salaf.

"Prestasi ini bukanlah akhir dari perjuangan, melainkan pemantik semangat agar para santri semakin mencintai kitab kuning warisan para ulama madzhab. Belajarlah dengan ikhlas demi menghilangkan ketidaktahuan, bukan semata-mata mencari piala," pesan luhur beliau.`,
    category: 'Prestasi',
    image: 'https://images.unsplash.com/photo-1506880018603-83d5b814b5a6?auto=format&fit=crop&w=800&q=80',
    date: '02 Mei 2026',
    author: 'Redaksi Berita',
    readTime: '3 menit'
  },
  {
    id: 'n3',
    title: 'Peringatan Nuzulul Qur\'an dan Doa Bersama untuk Keselamatan Bangsa',
    summary: 'Pesantren menggelar malam peringatan Nuzulul Qur\'an dengan khidmat yang dihadiri oleh para kiai sepuh, tokoh masyarakat, serta seluruh jajaran santri.',
    content: `Yosowilangun – Ribuan santri putra dan putri Pondok Pesantren Darul Mushtofa Assunniyyah memadati Masjid Jami' Al-Ittihad di kompleks pesantren untuk memperingati malam Nuzulul Qur'an 17 Ramadhan. Acara yang dikemas dalam bentuk Khataman Qur'an bil Ghaib, Dzikir Bersama, dan Tausiyah Keagamaan ini berlangsung dengan sangat khidmat di bawah siraman cahaya lampu masjid yang hangat.

Acara tahunan ini dihadiri oleh jajaran Kiai Sepuh Lumajang, tokoh masyarakat, aparat pemerintah kecamatan Yosowilangun, serta wali santri sekitar. 

Tausiyah utama disampaikan oleh KH Ali Sibro Mulisi. Beliau mengupas tentang mukjizat terbesar Nabi Muhammad SAW, yaitu Al-Qur'anul Karim, serta pentingnya menanamkan kecintaan membaca dan mengamalkan isi Al-Qur'an dalam kehidupan sehari-hari.

"Al-Qur'an diturunkan bukan hanya untuk dipajang atau dibaca sebagai pelengkap ibadah saja, melainkan sebagai dustur (pedoman hidup) yang menuntun arah berfikir, berucap, dan bertindak. Santri harus menjadi garda terdepan dalam mempraktikkan akhlak Al-Qur'an di tengah riuhnya arus globalisasi," tegas beliau.`,
    category: 'Kegiatan',
  ...
  {
    id: 'n4',
    title: 'Mengapa Belajar Nahwu Shorof Penting bagi Generasi Muda Muslim?',
    summary: 'Ulasan mendalam mengenai urgensi menguasai tata bahasa Arab (Nahwu dan Shorof) sebagai kunci utama membuka gudang ilmu keislaman tradisional.',
    content: `Oleh: Ust. H. Ahmad Fauzan, M.Pd. (Kepala Bidang Pendidikan)

Bahasa Arab adalah bahasa kehormatan umat Islam. Di dalamnya terkandung firman-firman suci Allah SWT (Al-Qur'an) dan sabda-sabda mutiara Rasulullah SAW (Al-Hadits). Namun, untuk dapat menyelami makna terdalam dari kedua sumber hukum Islam tersebut, serta memahami samudera kitab-kitab fikih dan tasawuf para ulama klasik, diperlukan kunci pembuka utama. Kunci itu adalah ilmu Nahwu (tata kalimat) dan Shorof (morfologi kata).

Para ulama mengibaratkan ilmu Nahwu sebagai bapak segala ilmu keislaman, dan ilmu Shorof sebagai ibunya. "Al-Nahwu Abu Al-Ilmi wa Al-Shorfu Ummuhu". Tanpa penguasaan yang kokoh terhadap kedua ilmu gramatika ini, seseorang sangat rentan salah dalam memahami nash (teks agama), yang pada gilirannya dapat melahirkan kesimpulan hukum yang keliru dan menyesatkan.

Di Pondok Pesantren Darul Mushtofa Assunniyyah, pembelajaran Nahwu dan Shorof diberikan dengan porsi yang sangat istimewa sejak santri menginjak kelas persiapan (I'dad). Metode hafalan matan kitab secara berirama (seperti Matan Al-Jurumiyyah, Imrithi, hingga Alfiyah Ibnu Malik) dipadukan dengan praktik i'rab (analisis kedudukan kata) langsung pada teks-teks kitab fiqih kuning.`,
    category: 'Opini',
    image: 'https://images.unsplash.com/photo-1517486808906-6ca8b3f04846?auto=format&fit=crop&w=800&q=80',
    date: '15 April 2026',
    author: 'Ust. H. Ahmad Fauzan',
    readTime: '6 menit'
  },
  {
    id: 'n5',
    title: 'Metode Tikrar dan Ziyadah: Kunci Sukses Menghafal Al-Qur\'an 30 Juz Mutqin',
    summary: 'Panduan praktis metode pengulangan (tikrar) dan penambahan hafalan baru (ziyadah) yang diterapkan di Lembaga Tahfidz Darul Mushtofa.',
    content: `Oleh: Ustadz Muhammad Baihaqi, Al-Hafidz (Pembina Tahfidz)

Menghafal Al-Qur'an bukan sekadar perlombaan memperbanyak juz hafalan, melainkan proses menanamkan kalamullah ke dalam sanubari secara kokoh dan mutqin (tidak mudah lupa). Di Pondok Pesantren Darul Mushtofa Assunniyyah, para santri tahfidz dibimbing menggunakan perpaduan metode Ziyadah (menambah hafalan baru) dan Tikrar (mengulang hafalan lama secara intensif).

Setiap santri diwajibkan melakukan muraja'ah minimal 1 juz setiap hari sebelum memulai setoran ayat baru kepada para asatidz bersanad. Dengan pembiasaan bangun di sepertiga malam dan melafalkan hafalan dalam shalat tahajud, hafalan yang tersimpan di memori jangka pendek perlahan berpindah menjadi memori permanen.

Kunci terpenting dari keberhasilan menghafal Al-Qur'an adalah keikhlasan niat, menjauhi maksiat mata dan hati, serta kesabaran yang tiada henti dalam mengulang ayat-ayat suci.`,
    category: 'Opini',
    image: 'https://images.unsplash.com/photo-1588072432836-e10032774350?auto=format&fit=crop&w=800&q=80',
    date: '08 April 2026',
    author: 'Ust. M. Baihaqi, Al-Hafidz',
    readTime: '5 menit'
  }
];
